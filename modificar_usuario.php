...
?>				
	...
	<p class="campo"><input type="input" value="<?php echo $direccion; ?>" name="direccion" id="midireccion"></p>

	<p class="etiqueta">Teléfono:</p>
	<p class="campo"><input type="tel" value="<?php echo $telefono; ?>" name="telefono" id="mitelefono"></p>
